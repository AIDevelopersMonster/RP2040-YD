# Video https://youtu.be/p2iqiROYjW0
# Post http://kontakts.ru/showthread.php/40884?p=86134#post86134
import utime
...
vibration_sensor = Pin(13, Pin.IN, Pin.PULL_UP)  # Датчик вибрации
...
while True:
    if vibration_sensor.value() == 0:  # Если датчик вибрации замкнул контакты
        alarm_triggered = True
        print("Vibration detected, alarm triggered!")
